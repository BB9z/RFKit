...
@interface NSDictionary<__covariant KeyType, __covariant ObjectType> (RFKit)
 ...
 */
- (BOOL)boolForKey:(nonnull KeyType)aKey API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));
 ...
 */
- (NSInteger)integerForKey:(nonnull KeyType)aKey API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));
 ...
 */
- (float)floatForKey:(nonnull KeyType)aKey API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));
 ...
 */
- (double)doubleForKey:(nonnull KeyType)aKey API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));
 ...
 */
- (NSUInteger)addEntriesFromDictionary:(nullable NSDictionary *)sourceDictionary withSpecifiedKeys:(nullable KeyType)firstKey, ... NS_REQUIRES_NIL_TERMINATION API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));

/**
 Adds to the receiving dictionary the entries from another dictionary with specified keys.
 
 @param sourceDictionary The dictionary from which to add entries.
 @param keys Array contains keys specifying which entry will be added to the reciver.
 
 @return Number of values added from sourceDictionary to the receiver.
 */
- (NSUInteger)addEntriesFromDictionary:(nullable NSDictionary *)sourceDictionary filterKeys:(nullable NSArray<KeyType> *)keys API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0), watchos(2.0));
 ...
 */
- (void)rf_setObject:(nullable ObjectType)anObject forKey:(nullable KeyType)aKey API_AVAILABLE(macos(10.0), ios(2.0), tvos(9.0), watchos(2.0));
 ...
 */
- (void)rf_removeObjectForKey:(nullable KeyType)aKey API_AVAILABLE(macos(10.0), ios(2.0), tvos(9.0), watchos(2.0));
